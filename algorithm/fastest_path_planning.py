...
def search(maze, cost, start, end):
    ...
    while len(yet_to_visit_list) > 0:
        ...
        if end_node.position[0]>15 or end_node.position[0]<4:
            ENDS=True
            if (current_node.position[0] == end_node.position[0]) and (current_node.position[1]-4 == end_node.position[1] or current_node.position[1]+4 == end_node.position[1]):
                return return_path(current_node, maze)
        elif  end_node.position[1]<4 or end_node.position[1]>15:
            ENDS=True
            if (current_node.position[0]-4 == end_node.position[0] or current_node.position[0]+4 == end_node.position[0]) and (current_node.position[1]== end_node.position[1]):
                return return_path(current_node, maze)
        elif current_node.position[0] == end_node.position[0] and current_node.position[1] == end_node.position[1] and ENDS!=True:
            return return_path(current_node, maze)
